...
CCScene * LoadingChan::scene()
{
    CCScene * scene = CCScene::create();
    LoadingChan * layer = LoadingChan::create() ;
...
void LoadingChan::createScreen()
{
    ...
    CCAction * timeAction2 = CCSequence::create ( CCProgressTo::create( 3 , 100 ) ,
                                                 CCCallFuncN::create ( this , callfuncN_selector( LoadingChan::gameStart )) , NULL );
...
void LoadingChan::gameStart()
{
    CCScene* newScene = CCTransitionMoveInR::create(0.2f, ChanLayer::scene() );
